...
class About(object):
    ...
    def process(self, fields, running_inventory=False,
    ...
    def load_dict(self, fields_dict, scancode =False, running_inventory=False, reference_dir=None,):
        """
...
def pre_process_and_fetch_license_dict(abouts, url, scancode):
    ...
    for about in abouts:
        ...
        if scancode:
            ...
            if not about.license_expression.present:
                continue
            else:
